  ...
  pt: {
    ...
    storeSection: {
      ...
      items: [
        ...
        {
          id: "course-combo",
          title: "Combo: Hieróglifos + Arqueoastronomia",
          category: "courses",
          price: "R$ 347",
          desc: "Os dois cursos juntos: 64 horas, 16 módulos. Separados sairiam R$ 444.",
          tag: "Os dois cursos • 64h",
          rating: "Economia de R$ 97",
        },
      ],
    },
    math: {
  ...
  en: {
    ...
    storeSection: {
      ...
      items: [
        ...
        {
          id: "course-combo",
          title: "Bundle: Hieroglyphs + Archaeoastronomy",
          category: "courses",
          price: "R$ 347",
          desc: "Both courses together: 64 hours, 16 modules. Separately they would cost R$ 444.",
          tag: "Both courses • 64h • in Portuguese",
          rating: "You save R$ 97",
        },
      ],
    },
    math: {
  ...
  es: {
    ...
    storeSection: {
      ...
      items: [
        ...
        {
          id: "course-combo",
          title: "Combo: Jeroglíficos + Arqueoastronomía",
          category: "courses",
          price: "R$ 347",
          desc: "Los dos cursos juntos: 64 horas, 16 módulos. Por separado costarían R$ 444.",
          tag: "Los dos cursos • 64h • en portugués",
          rating: "Ahorro de R$ 97",
        },
      ],
    },
    math: {
